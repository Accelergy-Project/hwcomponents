...
class EnergyAreaEstimatorWrapper(ListLoggable):
    ...
    def __init__(self, estimator_cls: type, component_name: str):
        ...
        self.component_name = estimator_cls.component_name
        ...
        logging.info(
            f"Added estimator {self.estimator_name} that estimates {self.component_name} with actions "
    ...
    def is_class_supported(self, query: EnergyAreaQuery) -> bool:
        ...
        if not query.component_name in name_check:
            self.logger.error(
